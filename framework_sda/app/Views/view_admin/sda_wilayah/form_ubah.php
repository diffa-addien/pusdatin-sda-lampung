...
<div class="card">
  <div class="card-body">
    ...
    <form class="was-validated" action="<?=base_url('Admin/ubah_sda_wilayah/'.$data_SDA['id'])?>" method="POST"
      enctype="multipart/form-data">
      <input type="hidden" name="id_wilayah" value="<?=$data_SDA['id_wilayah']?>" required>
      <div class="mb-3 row">
        <div class="col-8">
